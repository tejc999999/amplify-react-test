...
export default function NavBar(props) {
  const { fafa, test, item3, item1, item2, item4, overrides, ...rest } = props;
  const logoTwoNineSevenSixSevenZeroSevenFiveOnClick = useNavigateAction({
    type: "url",
    url: "/",
  });
  const jobsOnClick = useNavigateAction({ type: "url", url: "/todo" });
  const companyOnClick = useNavigateAction({
    type: "url",
    url: "https://www.jc-21.ac.jp/index.shtml",
  });
  return (
    <Flex
      gap="20px"
